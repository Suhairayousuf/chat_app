...
class EditBranchWidget extends ConsumerStatefulWidget {
  final String branchName;
  const EditBranchWidget(this.branchName,
      {Key? key, 
        // required String branchName, required String branchEmail,
        // required String branchAddress, required String phNo,
      }) : super(key: key);

  @override
  ConsumerState<EditBranchWidget> createState() => _EditBranchWidgetState();
}

class _EditBranchWidgetState extends ConsumerState<EditBranchWidget> {
  ...
  void initState() {
    ...
    // branchAddress = TextEditingController(text:widget.branchAddrees )  ;
    // email = TextEditingController(text:widget.branchEmail )  ;
    // phoneNumber = TextEditingController(text:widget.phNo )  ;
    super.initState();
  }
  @override
